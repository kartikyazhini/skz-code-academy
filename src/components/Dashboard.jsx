...
import { Lock, CheckCircle, Zap, Shield, ArrowRight, RotateCcw } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="relative overflow-hidden bg-zinc-900/10 border border-zinc-800/50 rounded-[3rem] p-12 mb-8 shadow-2xl">
          ...
          <div className="relative z-10">
            ...
            <p className="text-zinc-400 text-lg max-w-xl mb-10 font-medium">
              Welcome back, Trainee. System has synchronized your progress.
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          <div className="bg-zinc-900/20 border border-zinc-800/50 p-8 rounded-[2.5rem] flex items-center gap-5 backdrop-blur-sm">
            <div className="w-12 h-12 bg-skz-green/10 rounded-2xl flex items-center justify-center text-skz-green border border-skz-green/20">
          ...
          <div className="bg-zinc-900/20 border border-zinc-800/50 p-8 rounded-[2.5rem] flex items-center gap-5 backdrop-blur-sm">
            ...
            <div>
              <p className="text-[10px] text-zinc-500 font-black uppercase tracking-widest">Sections Mastered</p>
              ...
              return (
                <motion.div
                  ...
                  className={`relative bg-zinc-900/10 border border-zinc-800/50 rounded-[3.5rem] p-10 shadow-2xl backdrop-blur-md transition-all group overflow-hidden ${
                    isLocked ? 'opacity-40 grayscale' : 'hover:border-skz-green/30'
                  }`}
                >
                  ...
                  <div className="relative z-10 flex flex-col h-full justify-between min-h-[200px]">
                    <div>
                      <div className="flex items-center gap-3 mb-4">
                        <div className={`p-2 rounded-xl ${isLocked ? 'bg-zinc-800' : 'bg-skz-green/10'}`}>
                          <Shield size={20} className={isLocked ? 'text-zinc-600' : 'text-skz-green'} />
                        </div>
                    ...
                    <div className="mt-8 flex items-center justify-between">
                      {isLocked ? (
                        ...
                        <div className="flex items-center justify-between w-full">
                          <span className="text-skz-green font-black uppercase text-[10px] tracking-widest flex items-center gap-2">
                             <CheckCircle size={16}/> Module Mastered
                          </span>
                          <button
                            onClick={() => onStart(module.id, module.sections[0].id)}
                            className="text-zinc-500 hover:text-white transition-colors flex items-center gap-2 text-[10px] font-black uppercase"
                          >
